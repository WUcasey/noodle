...
class SignInPage extends GetView<SignInController> {
          ...
          child: Column(
            children: [
              SizedBox(
                height: 180.h,
                width: 180.w,
                child: RiveAnimation.asset(controller.first_riv,
                  fit: BoxFit.contain,
                ),
              ),
              Padding(
  ...
  Widget build(BuildContext context){
    ...
    List<Widget> page = [KeepAliveWrapper(child:FirstPage()),KeepAliveWrapper(child:SecondPage(context)),KeepAliveWrapper(child:ThirdPage()),GetStart()];
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          SizedBox(
            width: 320.w,
            height: 660.h,
            child: RiveAnimation.asset(controller.back_riv,
              fit: BoxFit.contain,
            ),
          ),
          ...
          child: Row(
            ...
            children: List.generate(widget.dataList.length, 
              (index) =>Padding(
                ...
                height: 10.h,
                decoration: BoxDecoration(
                  color: index == _current ? AppColors.SecondText:AppColors.Thirdcolor,
                  borderRadius: BorderRadius.circular(12)
                ), 
                ),
              ),  
